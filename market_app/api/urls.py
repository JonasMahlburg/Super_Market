...
from .views import Marketsview, MarketDetail, market_view, market_single_view, Sellersview, SellerDetail, sellers_view, sellers_single_view,  Productsview, ProductDetail, product_view, product_single_view
